...
public class SaveAllButton implements Button {
    private final Vector2 pos;
    private final Vector2 size;
    private Color color;

    public SaveAllButton(Vector2 pos, Vector2 size) {
        this.pos = pos;
        this.size = size;
    ...
    public void paint(Graphics g) {
        ...
        g.drawString("Save", (int)(pos.getX()+size.getX()/5), (int)(pos.getY()+size.getY()/3));
